...
The analysis uses a restricted participant-level dataset preprocessed by YuFong. The dataset is stored separately from this public repository. Authorised researchers can supply its external file path through the `CDP_DATA_PATH` environment variable. See the [data availability and privacy statement](../../data/CDP-data.md) for handling requirements.
